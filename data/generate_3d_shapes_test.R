...
if (file.exists(file.path(data_dir, "test_healthy_100bp.fasta"))) {
    extract_3d_tensor(file.path(data_dir, "test_healthy_100bp.fasta"), file.path(data_dir, "wt_3d_shapes.tsv"))
    gc()
}
if (file.exists(file.path(data_dir, "test_mutated_100bp.fasta"))) {
    extract_3d_tensor(file.path(data_dir, "test_mutated_100bp.fasta"), file.path(data_dir, "mut_3d_shapes.tsv"))
    gc()
}
